...
(function () {
  ...
  // START APP
  // ======================================================
  // The entry file is deferred, so the complete document is available here.
  // Register image fallbacks before the browser can finish loading gallery
  // assets, then load the interactive modules once.
  function startApp() {
    handleImageErrors();
    loadAllModules();
  }
