...
export const RESERVED: ReservedZone[] = [
  ...
  },
  {
    ...
    tagline: "Every project, every story, on display", x: 0, z: -150, chapter: 3,
    info: "All completed projects and achievements will be exhibited here as interactive exhibits. Opening in Chapter 3.",
    accent: PALETTE.gold,
  },
  {
