...
export function SettingsPanel({ isOpen, onClose, settings, onSettingsChange }: SettingsPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-3xl border border-white/20 bg-[#0f172a] p-8">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              >
                <div className={`w-5 h-5 bg-white rounded-full transition-transform ${settings.sound ? 'translate-x-6' : 'translate-x-0.5'}`} />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <div className={`w-5 h-5 bg-white rounded-full transition-transform ${settings.music ? 'translate-x-6' : 'translate-x-0.5'}`} />
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className={`w-5 h-5 bg-white rounded-full transition-transform ${settings.motion ? 'translate-x-6' : 'translate-x-0.5'}`} />
            </button>
          </div>
        </div>
