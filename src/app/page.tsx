                ...
                <div className="flex flex-col h-full">
                  <div className="mb-8">
                    ...
                    <p className="text-[var(--color-text-secondary)] text-lg leading-relaxed">
                      Browse my portfolio in a clean, modern, and premium way. Perfect for quick
                      exploration and website orders.
                    </p>
                  </div>
              ...
              >
                <div className="flex flex-col h-full">
                  <div className="mb-8">
                    ...
                    <p className="text-[var(--color-text-secondary)] text-lg leading-relaxed">
                      Explore my portfolio inside an immersive 3D city experience. Every location
                      tells a different part of my story.
                    </p>
                  </div>
