...
export function ClientNotificationsManager({ initialNotifications }: ClientNotificationsManagerProps) {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-border/10 pb-6">
          <div>
            <h1 className="text-display-sm font-bold tracking-tight">
              <span className="text-gradient">নোটিফিকেশনস (My Alerts)</span>
            </h1>
            <p className="text-sm text-fg-soft mt-1">
              আপনার প্রজেক্টের বাজেট পরিবর্তন, চ্যাট মেসেজ এবং নতুন ফাইল রিসিভ হওয়ার নোটিফিকেশন এলার্ট তদারকি করুন।
            </p>
          </div>
